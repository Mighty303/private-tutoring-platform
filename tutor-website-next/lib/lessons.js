...
export const milestones = [
  {
    ...
    status: "complete",
    lessons: 6,
    topics: ["Variables and data types", "Type casting", "Operators", "User input", "Strings (f-strings, slicing, methods)", "Lists (append, remove, indexing)", "Conditionals (if/elif/else)", "While loops", "For loops", "Functions (basics)"],
  },
  {
    number: 2,
    ...
    status: "active",
    lessons: 5,
    topics: ["Dictionaries", "List comprehensions", "String formatting", "Error handling", "File I/O", "Modules"],
  },
  {
    number: 3,
    ...
    status: "upcoming",
    lessons: 7,
    topics: ["Classes & Objects", "Inheritance", "Game loops", "Random module", "Time module", "Simple graphics"],
  },
  {
    number: 4,
    ...
    status: "upcoming",
    lessons: 5,
    topics: ["APIs", "Web scraping", "Data analysis", "Discord bots", "Automation"],
  },
  {
    number: 5,
    ...
    status: "upcoming",
    lessons: 9,
    topics: ["GUI applications", "Databases", "Algorithms", "Data structures", "Final project"],
  },
];

export function getAllLessons() {
  return [...saturdayLessons, ...dictionaryExercises, ...sundayLessons, ...sundayAnswers];
}
